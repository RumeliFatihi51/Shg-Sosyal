...
class CommunitiesScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final tabs = {'recommended': 'Önerilen', 'active': 'Aktif', 'new': 'Yeni', 'joined': 'Katıldıklarım'};
      ...
      body: ListView(
        ...
        children: [
          ...
          communities.when(
            ...
            error: (_, __) => const AppEmptyState(title: 'Topluluklar yüklenemedi.', message: 'Birazdan tekrar dene.'),
            data: (items) => Column(
              children: [
